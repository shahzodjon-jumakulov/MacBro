    ...
    <div class="footer-nav">
      <div class="footer-nav-links">
        <ul class="footer-nav-item">
          <h3 class="title">Sotib ol</h3>
          <li>Mac</li>
          <li>iPad</li>
          <li>iPhone</li>
        </ul>
        <ul class="footer-nav-item">
          <h3 class="title">Kompaniya</h3>
          <li>Yangiliklar</li>
        ...
        <ul class="footer-nav-item">
          <h3 class="title">Biz bilan bog'laning</h3>
          <li class="social-link">
            <a
              href="https://www.facebook.com/macbrouz/"
            ...
            <a
              href="https://www.instagram.com/macbro.uz/"
              class="social-link-item"
            >
              <svg
                width="24"
            ...
            <a href="https://t.me/macbrouz" class="social-link-item">
              <svg
                width="24"
                height="24"
                class="MuiSvgIcon-root"
            ...
            <a
              href="https://www.youtube.com/channel/UCa2sZELOq4F6cAGsY23A6TA"
              class="social-link-item"
            >
              <svg
                width="24"
            ...
            <a
              href="https://www.tiktok.com/@macbro.uz"
              class="social-link-item"
            >
              <svg
                width="24"
      ...
      <div class="footer-copyright">
        ...
        <p>
          Cloned by
          <a href="https://t.me/its_shakh" class="author-link">Shahzod</a> |
          Developed by
          <a href="https://udevs.io/" class="author-link">Udevs</a>
        </p>
      </div>
    </div>
  </div>
